                ...
                <div class="menumenu__container clearfix">
                    ...
                    <div class="col-md-7 ">
                        <nav class="main__menu__nav hidden-xs hidden-sm">
                            <ul class="main__menu">
                                <li class="drop"><a href="/Project4">Trang chủ</a></li>
                             
                                <li class="drop">
                                    <a href="/Project4/cart">Giỏ hàng</a>
                                    <ul class="dropdown">
                                        <li><a href="/Project4/checkout">Thanh toán</a></li>
                                        <li><a href="/Project4/wishlist">Lịch sử mua hàng</a></li>
                                    </ul>
                                </li>

                                <li><a href="/Project4/contact">Liên hệ</a></li>
                            </ul>
                        </nav>
                        ...
                        <div class="mobile-menu clearfix visible-xs visible-sm">
                            <nav id="mobile_dropdown">
                                <ul>
                                    <li><a href="/Project4">Trang chủ</a></li>
                                    
                                    <li class="drop">
                                        <a href="/Project4/cart">Cart</a>
                                        <ul class="dropdown">
                                            <li><a href="/Project4/checkout">Thanh toán</a></li>
                                            <li><a href="/Project4/wishlist">Lịch sử mua hàng</a></li>
                                        </ul>
