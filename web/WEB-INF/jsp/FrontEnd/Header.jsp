<%-- 
    Document   : Header
    Created on : Jul 27, 2022, 11:32:47 PM
    Author     : bahop
--%>
...
<link href="<c:url value="/resources/resourceAdmin/vendor/fontawesome-free/css/all.min.css"/>" rel="stylesheet" type="text/css">
  
<!--<link href="<c:url value="/resources/resourceAdmin/css/sb-admin-2.min.css"/>" rel="stylesheet">-->
